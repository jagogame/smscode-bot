...
Object.assign(I18N.id,{
 ...
 'nav.partners':'Database Partner','nav.partners_map':'Peta Cakupan Partner','nav.partner_prospects':'Prospek Partner','nav.partner_evaluations':'Evaluasi Partner','nav.partner_payments':'Pembayaran Partner',
 ...
 'grp.crm_sales':'CRM & Sales','grp.purchasing':'Purchasing','grp.inventory':'Inventory','grp.finance':'Finance','grp.rental':'Rental','grp.service':'Service & Aftersales','grp.aftersales_partners':'Aftersales Partner Network','grp.approval':'Approval','grp.admin':'General Admin & HR','grp.other':'Lainnya',
 ...
 'ent.rent_units':'Unit Rental','ent.pm_schedules':'Jadwal PM','ent.partners':'Aftersales Partner','ent.partner_prospects':'Prospek Partner','ent.partner_evaluations':'Evaluasi Partner','ent.partner_payments':'Pembayaran Partner',
 ...
 'login.tagline':'Reliable Power & Energy Solutions.','login.point1':'Approval & workflow New Order terkontrol','login.point2':'Rental & service genset dalam satu sistem','login.point3':'Stok, keuangan, dan laporan real-time',
 ...
 'reports.partner_list':'Daftar Partner','reports.partner_prospect_list':'Daftar Prospek Partner','reports.partner_by_island':'Partner per Pulau','reports.partner_by_province':'Partner per Provinsi','reports.partner_coverage_gap':'Wilayah Belum Tercakup','reports.partner_coverage_detail':'Detail Wilayah Cakupan','reports.partner_job_history':'Riwayat Pekerjaan Partner','reports.partner_perf':'Kinerja & Rating Partner','reports.partner_cost':'Biaya Partner','reports.partner_payments_rep':'Pembayaran Partner','reports.partner_contract_expiry':'Kontrak Segera Berakhir','reports.partner_priority_regions':'Wilayah Prioritas Pengembangan Partner',
 'partner.status':'Status Kerjasama','partner.province':'Provinsi','partner.brands':'Merek / Jenis Mesin','partner.map_title':'Peta Cakupan Aftersales Partner','partner.view_list':'Tampilan Daftar','partner.view_map':'Tampilan Peta',
 'partner.search_ph':'Cari provinsi, kota, nama, atau kode partner…','partner.legend_active':'Aktif','partner.legend_full':'Resmi / Layanan Lengkap','partner.legend_prospect':'Prospek / Evaluasi','partner.legend_inactive':'Tidak Aktif / Blacklist',
 'partner.coverage_by_province':'Cakupan per Provinsi','partner.region_priority':'Wilayah Prioritas Pengembangan Partner','partner.col_active':'Aktif','partner.col_prospect':'Prospek','partner.col_inactive':'Tidak Aktif','partner.col_nearest':'Partner Terdekat',
 'partner.col_customers':'Customer','partner.col_priority':'Prioritas','partner.none':'Tidak ada','partner.rent_active':'Ada Kontrak Rental Aktif','partner.warranty_open':'Ada Service Bergaransi Berjalan','partner.map_load_failed':'Peta gagal dimuat (periksa koneksi ke CDN Leaflet). Gunakan tampilan daftar di bawah.',
 'partner.full_service':'Resmi / Lengkap','partner.rating':'Rating','partner.jobs':'Pekerjaan Selesai','partner.view_detail':'Lihat detail','partner.converted':'Sudah dikonversi','partner.convert_btn':'Jadikan Partner','partner.convert_title':'Konversi ke Partner Aktif',
 'partner.convert_confirm':'Konversi prospek "{name}" menjadi partner aktif? Data yang sudah diisi akan disalin otomatis.','partner.already_converted':'Prospek ini sudah dikonversi menjadi partner.','partner.convert_action':'Konversi ke Partner','partner.convert_success':'Partner baru dibuat: {code}',
 'partner.approvals_col':'Approval','partner.mark_paid':'Tandai Dibayar','partner.err_no_report':'Belum ada nomor Service Report — pembayaran tidak dapat diproses.','partner.err_approvals_incomplete':'Approval Manager Teknisi & Admin Aftersales belum lengkap — pembayaran tidak dapat diproses.',
 'partner.err_not_finance':'Hanya Finance/Direksi yang dapat menandai pembayaran selesai.','partner.err_not_authorized':'Anda tidak berwenang memberikan approval ini.','partner.paid_success':'Pembayaran ditandai selesai.','partner.approved_tm':'Disetujui Manager Teknisi.','partner.approved_aa':'Disetujui Admin Aftersales.',
 'partner.err_hr_cannot_activate':'General Admin/HR/Sales Support tidak berwenang mengaktifkan status partner menjadi Active — hanya dapat menyimpan sebagai data awal/prospek.','partner.err_province_required':'Provinsi wajib diisi untuk membuat kode partner otomatis.',
 'partner.assign_btn':'Rekomendasi & Tugaskan Partner','partner.assign_other_btn':'Tugaskan Partner Lain','partner.assigned_partner':'Partner Ditugaskan','partner.assigned_success':'Partner {name} ditugaskan.','partner.col_dist':'Jarak','partner.col_name':'Nama',
 'partner.col_score':'Skor','partner.evaluate_btn':'Buat Evaluasi Partner','partner.no_recommendation':'Tidak ada partner aktif dengan koordinat untuk direkomendasikan.','partner.override_reason':'Alasan (wajib bila memilih partner lain)','partner.override_reason_required':'Alasan wajib diisi saat memilih partner di luar rekomendasi.',
 'partner.pick_btn':'Pilih','partner.pick_other_hint':'Atau pilih partner lain di luar daftar rekomendasi (wajib isi alasan).','partner.pick_other_label':'Partner lain','partner.pick_other_required':'Pilih partner terlebih dahulu.','partner.recommend_title':'Rekomendasi Aftersales Partner'
});
Object.assign(I18N.en,{
 ...
 'nav.partners':'Partner Database','nav.partners_map':'Partner Coverage Map','nav.partner_prospects':'Partner Prospects','nav.partner_evaluations':'Partner Evaluations','nav.partner_payments':'Partner Payments',
 ...
 'nav.reports':'Reports','nav.master':'Master Data','nav.users':'User & Access','nav.audit':'Audit Log','nav.settings':'Settings',
 'grp.crm_sales':'CRM & Sales','grp.purchasing':'Purchasing','grp.inventory':'Inventory','grp.finance':'Finance','grp.rental':'Rental','grp.service':'Service & Aftersales','grp.aftersales_partners':'Aftersales Partner Network','grp.approval':'Approval','grp.admin':'General Admin & HR','grp.other':'Other',
 ...
 'ent.rent_units':'Rental Unit','ent.pm_schedules':'PM Schedule','ent.partners':'Aftersales Partner','ent.partner_prospects':'Partner Prospect','ent.partner_evaluations':'Partner Evaluation','ent.partner_payments':'Partner Payment',
 ...
 'reports.partner_list':'Partner List','reports.partner_prospect_list':'Prospect List','reports.partner_by_island':'Partners by Island','reports.partner_by_province':'Partners by Province','reports.partner_coverage_gap':'Uncovered Regions','reports.partner_coverage_detail':'Coverage Area Detail','reports.partner_job_history':'Partner Job History','reports.partner_perf':'Partner Performance & Rating','reports.partner_cost':'Partner Cost','reports.partner_payments_rep':'Partner Payments','reports.partner_contract_expiry':'Contracts Expiring Soon','reports.partner_priority_regions':'Priority Regions for Partner Development',
 'partner.status':'Cooperation Status','partner.province':'Province','partner.brands':'Brand / Engine Type','partner.map_title':'Aftersales Partner Coverage Map','partner.view_list':'List View','partner.view_map':'Map View',
 'partner.search_ph':'Search province, city, partner name, or code…','partner.legend_active':'Active','partner.legend_full':'Official / Full Service','partner.legend_prospect':'Prospect / Under Evaluation','partner.legend_inactive':'Inactive / Blacklisted',
 'partner.coverage_by_province':'Coverage by Province','partner.region_priority':'Priority Regions for Partner Development','partner.col_active':'Active','partner.col_prospect':'Prospect','partner.col_inactive':'Inactive','partner.col_nearest':'Nearest Partner',
 'partner.col_customers':'Customers','partner.col_priority':'Priority','partner.none':'None','partner.rent_active':'Has Active Rental Contract','partner.warranty_open':'Has Open Warranty Service','partner.map_load_failed':'Map failed to load (check connection to Leaflet CDN). Use the list view below instead.',
 'partner.full_service':'Official / Full Service','partner.rating':'Rating','partner.jobs':'Completed Jobs','partner.view_detail':'View detail','partner.converted':'Already converted','partner.convert_btn':'Convert to Partner','partner.convert_title':'Convert to Active Partner',
 'partner.convert_confirm':'Convert prospect "{name}" into an active partner? Existing data will be copied automatically.','partner.already_converted':'This prospect has already been converted.','partner.convert_action':'Convert to Partner','partner.convert_success':'New partner created: {code}',
 'partner.approvals_col':'Approval','partner.mark_paid':'Mark Paid','partner.err_no_report':'No service report number yet — payment cannot be processed.','partner.err_approvals_incomplete':'Technical Manager & Admin Aftersales approvals are not both complete — payment cannot be processed.',
 'partner.err_not_finance':'Only Finance/Directors can mark a payment as paid.','partner.err_not_authorized':'You are not authorized to give this approval.','partner.paid_success':'Payment marked as paid.','partner.approved_tm':'Approved by Technical Manager.','partner.approved_aa':'Approved by Admin Aftersales.',
 'partner.err_hr_cannot_activate':'General Admin/HR/Sales Support cannot activate a partner status to Active — can only save it as initial/prospect data.','partner.err_province_required':'Province is required to generate the automatic partner code.',
 'partner.assign_btn':'Recommend & Assign Partner','partner.assign_other_btn':'Assign a Different Partner','partner.assigned_partner':'Assigned Partner','partner.assigned_success':'Partner {name} assigned.','partner.col_dist':'Distance','partner.col_name':'Name',
 'partner.col_score':'Score','partner.evaluate_btn':'Create Partner Evaluation','partner.no_recommendation':'No active partner with coordinates to recommend.','partner.override_reason':'Reason (required if picking another partner)','partner.override_reason_required':'A reason is required when assigning a partner outside the recommendations.',
 'partner.pick_btn':'Pick','partner.pick_other_hint':'Or pick a different partner outside the recommendation list (reason required).','partner.pick_other_label':'Other partner','partner.pick_other_required':'Please select a partner first.','partner.recommend_title':'Aftersales Partner Recommendation'
});
Object.assign(I18N.zh,{
 ...
 'nav.partners':'合作伙伴数据库','nav.partners_map':'合作伙伴覆盖地图','nav.partner_prospects':'合作伙伴潜在客户','nav.partner_evaluations':'合作伙伴评估','nav.partner_payments':'合作伙伴付款',
 ...
 'grp.crm_sales':'客户关系与销售','grp.purchasing':'采购','grp.inventory':'库存','grp.finance':'财务','grp.rental':'租赁','grp.service':'服务与售后','grp.aftersales_partners':'售后合作伙伴网络','grp.approval':'审批','grp.admin':'行政与人事','grp.other':'其他',
 ...
 'ent.rent_units':'租赁设备','ent.pm_schedules':'保养计划','ent.partners':'售后合作伙伴','ent.partner_prospects':'合作伙伴潜在客户','ent.partner_evaluations':'合作伙伴评估','ent.partner_payments':'合作伙伴付款',
 ...
 'reports.partner_list':'合作伙伴列表','reports.partner_prospect_list':'潜在客户列表','reports.partner_by_island':'按岛屿划分的合作伙伴','reports.partner_by_province':'按省份划分的合作伙伴','reports.partner_coverage_gap':'未覆盖区域','reports.partner_coverage_detail':'覆盖区域明细','reports.partner_job_history':'合作伙伴工作历史','reports.partner_perf':'合作伙伴绩效与评分','reports.partner_cost':'合作伙伴成本','reports.partner_payments_rep':'合作伙伴付款','reports.partner_contract_expiry':'即将到期合同','reports.partner_priority_regions':'合作伙伴发展优先区域',
 'partner.status':'合作状态','partner.province':'省份','partner.brands':'品牌/机型','partner.map_title':'售后合作伙伴覆盖地图','partner.view_list':'列表视图','partner.view_map':'地图视图',
 'partner.search_ph':'搜索省份、城市、合作伙伴名称或代码…','partner.legend_active':'活跃','partner.legend_full':'官方/服务完善','partner.legend_prospect':'潜在客户/评估中','partner.legend_inactive':'不活跃/黑名单',
 'partner.coverage_by_province':'按省份覆盖情况','partner.region_priority':'合作伙伴发展优先区域','partner.col_active':'活跃','partner.col_prospect':'潜在客户','partner.col_inactive':'不活跃','partner.col_nearest':'最近的合作伙伴',
 'partner.col_customers':'客户','partner.col_priority':'优先级','partner.none':'无','partner.rent_active':'有生效中的租赁合同','partner.warranty_open':'有进行中的保修服务','partner.map_load_failed':'地图加载失败（请检查与 Leaflet CDN 的连接）。请改用下方的列表视图。',
 'partner.full_service':'官方/服务完善','partner.rating':'评分','partner.jobs':'已完成工作','partner.view_detail':'查看详情','partner.converted':'已转换','partner.convert_btn':'转为合作伙伴','partner.convert_title':'转换为正式合作伙伴',
 'partner.convert_confirm':'将潜在客户 "{name}" 转换为正式合作伙伴？已填写的数据将自动复制。','partner.already_converted':'该潜在客户已转换为合作伙伴。','partner.convert_action':'转换为合作伙伴','partner.convert_success':'已创建新合作伙伴：{code}',
 'partner.approvals_col':'审批','partner.mark_paid':'标记为已付款','partner.err_no_report':'尚无服务报告编号 — 无法处理付款。','partner.err_approvals_incomplete':'技术经理与售后行政的审批尚未全部完成 — 无法处理付款。',
 'partner.err_not_finance':'只有财务/总监可以将付款标记为完成。','partner.err_not_authorized':'您无权进行此审批。','partner.paid_success':'付款已标记为完成。','partner.approved_tm':'已获技术经理批准。','partner.approved_aa':'已获售后行政批准。',
 'partner.err_hr_cannot_activate':'行政人事及销售支持无权将合作伙伴状态激活为“活跃” — 只能保存为初始/潜在客户数据。','partner.err_province_required':'需填写省份才能自动生成合作伙伴代码。',
 'partner.assign_btn':'推荐并指派合作伙伴','partner.assign_other_btn':'指派其他合作伙伴','partner.assigned_partner':'已指派合作伙伴','partner.assigned_success':'已指派合作伙伴 {name}。','partner.col_dist':'距离','partner.col_name':'名称',
 'partner.col_score':'评分','partner.evaluate_btn':'创建合作伙伴评估','partner.no_recommendation':'没有可推荐的、含坐标的活跃合作伙伴。','partner.override_reason':'原因（选择其他合作伙伴时必填）','partner.override_reason_required':'指派推荐名单之外的合作伙伴时必须填写原因。',
 'partner.pick_btn':'选择','partner.pick_other_hint':'或从推荐名单之外选择其他合作伙伴（须填写原因）。','partner.pick_other_label':'其他合作伙伴','partner.pick_other_required':'请先选择一个合作伙伴。','partner.recommend_title':'售后合作伙伴推荐'
});
